...
public class DeleteCategoryHandlerTests
{
    ...
    public void SetUp()
    {
        ...
        _handler = new DeleteCategoryHandler(_unitOfWork.Object, _logger.Object, _publishEndpoint.Object);
    }
    ...
    public async Task Handle_WhenCalled_ShouldReturnTrue()
    {
        ...
        _unitOfWork.Setup(x => x.BeginTransactionAsync(_cancellationToken))
    ...
    public async Task Handle_WhenNotAdmin_ShouldThrowException()
    {
        ...
        // Act & Assert
        var exception =
            Assert.ThrowsAsync<ForbiddenAccessException>(() => _handler.Handle(command, _cancellationToken));
    }
}