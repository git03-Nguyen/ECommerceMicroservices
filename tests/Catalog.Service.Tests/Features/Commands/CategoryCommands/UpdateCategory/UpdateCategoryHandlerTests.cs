...
public class UpdateCategoryHandlerTests
{
    ...
    public void SetUp()
    {
        ...
        _handler = new UpdateCategoryHandler(_logger.Object, _unitOfWork.Object);
    }
    ...
    public async Task Handle_WhenCategoryNotFound_ShouldThrowException()
    {
        ...
        _unitOfWork.Setup(u => u.CategoryRepository.GetByIdAsync(request.Payload.CategoryId))
    ...
    public async Task Handle_WhenCalled_ShouldUpdateCategory()
    {
        ...
        Assert.That(result.Payload.Name, Is.EqualTo(request.Payload.Name ?? category.Name));
        Assert.That(result.Payload.Description, Is.EqualTo(request.Payload.Description ?? category.Description));
