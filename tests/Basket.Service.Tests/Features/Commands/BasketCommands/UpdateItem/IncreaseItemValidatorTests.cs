...
[TestFixture]
public class DecreaseItemValidatorTests
{
    private IncreaseItemValidator _validator;
    ...
    public void SetUp()
    {
        _validator = new IncreaseItemValidator();
    ...
    {
        // Arrange
        var command = new IncreaseItemCommand(_request);
